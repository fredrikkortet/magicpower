...
theme.taglist_fg_focus                          = xrdb.color7
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#343434"),
            ...
            arrow("alpha", xrdb.color10),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), xrdb.color10),
            arrow(xrdb.color10, xrdb.color6),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), xrdb.color6),
            arrow(xrdb.color6, xrdb.color10),
            --wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), xrdb.color10),
            --arrow(xrdb.color10, xrdb.color6),
            --wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), xrdb.color6),
            --arrow(xrdb.color6, xrdb.color10),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), xrdb.color10),
            arrow(xrdb.color10, xrdb.color6),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), xrdb.color6),
            arrow(xrdb.color6, xrdb.color10),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), xrdb.color10),
            arrow(xrdb.color10, xrdb.color6),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), xrdb.color6),
            arrow(xrdb.color6, "alpha"),
