...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "w", function () awful.util.spawn( browser ) end,
        {description = browser, group = "super+shift"}),
    awful.key({ modkey,"Shift"}, "e", function () awful.util.spawn( terminal.." -e "..editor ) end,
        {description = editor, group = "super+shift"}),
    awful.key({ modkey,"Shift"}, "h", function () awful.util.spawn( terminal.." -e htop" ) end,
        {description = "Htop", group = "super+shift"}),
    awful.key({ modkey,"Shift"}, "Return", function () awful.util.spawn( terminal ) end,
        {description = terminal, group = "super+shift"}),
    awful.key({ modkey,"Shift" }, "v", function () awful.util.spawn( "pavucontrol" ) end,
        {description = "Volume control", group = "super+shift"}),
    awful.key({ modkey, "Shift"   }, "d", function() awful.util.spawn( terminal.." -e "..filemanager ) end,
        {description = filemanager, group = "super+shift"}),
    awful.key({ modkey, "Shift"   }, "t", function() awful.util.spawn( filemanagergui ) end,
        {description = filemanagergui, group = "super+shift"}),
    awful.key({ modkey, "Shift"  }, "n", function() awful.util.spawn( "networkmanager_dmenu") end,
        {description = "Network manager", group="super+shift"}),
    awful.key({ modkey, "Shift"  }, "b", function() awful.util.spawn( "bluetoothdm") end,
        {description = "Bluetooth manager", group="super+shift"}),
    awful.key({ modkey, "Shift"  }, "s", function() awful.util.spawn( mediaplayer ) end,
        {description = mediaplayer, group="super+shift"}),
    awful.key({ modkey, "Shift"  }, "m", function() awful.util.spawn( mailclient ) end,
        {description = mailclient, group="super+shift"}),
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot '%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $HOME/Pictures'") end,
