...
#include "/home/tipparn/.cache/wal/colors-wal-dwm.h"
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", norm_bg, "-nf", norm_fg, "-sb", col2, "-sf", sel_fg, NULL };
