...
#define PATH(name)                      "/home/tipparn/.dwm/dwmblocks/blocks/"name
...
/*      pathu                           pathc                           interval        signal */
        { PATH("memory"),            PATH("memory_button"),       1,              1},
        { PATH("volume"),            PATH("volume_button"),       1,              2},
        { PATH("internet"),          PATH("internet_button"),     60,             3},
        { PATH("battery"),           PATH("battery_button"),      30,             4},
        { PATH("calendar"),          NULL,                        30,             5},
